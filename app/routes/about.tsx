            ...
            <main className="md:w-8/12 about-page">
                ...
                <div className="mt-16 mb-32">
                    <p className="about-desc">
                        My name is <span className="font-bold">Oluwatobiloba Light</span>, a reserved and cool guy 😄, a team player 🤝 , a frontend developer, originally from Ogun state, Nigeria and, currently based in Lagos, Nigeria.
                        <br />
                        <br />
